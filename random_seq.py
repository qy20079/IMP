...
# Generate random protein sequence of a given length
def generate_random_sequence(length):
    bases = "ACDEFGHIKLMNPQRSTVWY"  # Amino acids
    return ''.join(random.choice(bases) for _ in range(length))

# Generate random set of protein sequences with special fasta headings
...
SeqIO.write(sequences, "random_sequences.fasta", "fasta")
